...
require_once ('../Models/modelRescate.php');
...
if(isset($_GET["getRescates"])){
    
    if($json = $m->getRescatesAll()){
        echo json_encode($json);
    }else{
        echo json_encode(false);
    }
...
if(isset($_POST["eliminarRescate"])){

    if($json = $m->eliminarRescate($_POST["eliminarRescate"])){
